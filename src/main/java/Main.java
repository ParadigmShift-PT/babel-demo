...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String port = argValue(args, "babel.port", "6000");
        ...
        // A nickname is mandatory — it is how you appear in the chat.
        ...
        if (nick == null || nick.isBlank()) {
            ...
            System.err.println("  nick=<name>            your chat nickname (required)");
            ...
            System.err.println("  interface=<nic>        network interface to bind/announce on");
            System.err.println("                         (e.g. en0 / eth0); needed for LAN discovery");
            System.err.println("  contact=<host>:<port>  seed peer if multicast discovery is");
            System.err.println("                         unavailable; 'none' = I am the first node");
            System.exit(1);
        }

        // If an interface name was given, resolve it to a concrete IPv4 address
        // (stored under the "address" property) so discovery announces something
        // reachable rather than localhost.
        ...
        String bindAddress = props.getProperty("babel.address",
                props.getProperty("address", "127.0.0.1"));
        int bindPort = Integer.parseInt(props.getProperty("babel.port", "6000"));
